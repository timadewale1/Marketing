 ...
 * 
 * User interface for initiating wallet withdrawal to bank account.
 * Calculates fees, validates amounts, and shows bank details.
 * 
 * Features:
 ...
 * - Requires bank details to be set in profile first
 * 
 * Usage:
 * <WithdrawDialog
 *   open={isOpen}
...
export function WithdrawDialog({
  ...
  // Calculate 10% service fee and net amount
        ...
        <div className="mt-6 space-y-4">
          ...
          {bankDetails ? (
            <div className="p-4 bg-amber-50 rounded-lg border border-amber-100">
              <div className="text-sm text-amber-600">Bank Account</div>
          ...
          {amount && (
            <>
              ...
              {Number(amount) > maxAmount && (
                <p className="text-sm text-red-600">Amount exceeds your available balance</p>
              )}
              {/* Fee preview */}
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Button variant="outline" onClick={onClose} className="hover:bg-primary-100">
              Cancel
            </Button>
          </div>
        </div>
