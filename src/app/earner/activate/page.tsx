  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-lg w-full p-8 bg-white rounded-lg shadow text-center">
        ...
        <p className="mb-4">The activation flow now opens an inline Monnify modal from your dashboard. You will be redirected back shortly.</p>
        <p className="text-sm text-stone-500">If you were redirected here from Monnify, the activation callback is handled automatically.</p>
      </div>
    </div>
  );
}
