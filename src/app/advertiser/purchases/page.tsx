...
export default function AdvertiserPurchasesPage() {
      ...
      <div className="mx-auto max-w-4xl space-y-4">
        ...
        {records.length === 0 ? (
          <Card className="rounded-2xl border-stone-200 bg-white p-8">
            <p className="text-sm text-stone-600">No marketplace purchases yet.</p>
          </Card>
        ) : (
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right">
                    ...
                    {record.status === "approved" ? (
                      <p className="mt-1 text-sm text-emerald-600">Cashback ₦{record.cashbackAmount.toLocaleString()}</p>
                    ) : null}
                  </div>
                </div>
              </Card>
