      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 space-y-6 bg-gradient-to-br from-gold-50 to-primary-100">
          ...
          <section>
            ...
            <div className="space-y-2 text-primary-600">
              <p>
                Blessed Token is provided &quot;as is&quot; without any warranties. We are not liable for:
              </p>
              <ul className="list-disc pl-6">
          ...
          <div className="mt-8 text-sm text-primary-500">
            ...
            <p>For questions about these Terms, contact us at support@blessedtoken.com</p>
          </div>
        </Card>
      </div>
    </div>
